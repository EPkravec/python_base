...
#  немогу согласиться с Вами так как точка более 42 единиц, по замечанию дописал изменение >=,
# - В данном случае да, но у тебя может быть случай, когда точка расстояние от начала координат до точки будет
# ровно 42, ты же пишешь решение не под конкретный случай.
