...
for y in range(0, 700, 50):
    ...
    if (y / 50) % 2 == 0:
        ...
        for x in range(0, 700, 100):
            # TODO такие принты по моему лучше для тестирования, также ты итерируешься переменной х,
            #  а до этого её вычисляешь, так вот тут она будет меняться при каждой итерации и вычисление
            #  до цикла вообще не будет учитываться, введи разные переменные для этого
            print(x, y)
            print(x1, y1)
